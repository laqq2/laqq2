...
Software Engineering student @ Monash · Founder of LockonAI · Builder
...
**[Focal](https://focal-web-alpha.vercel.app/app)** — Chrome extension built around Kolb's Reflection Cycle and iCanStudy principles. Focus timer, distraction logging, task management, Google Calendar sync.
...
`Python` `JavaScript` `React` `Supabase` `Vercel` `REST APIs` `Vite` `HTML/CSS`

---

### Connect
- 🌐 [evanbuilds.vercel.app](https://evanbuilds.vercel.app)
- 📧 [evankonggg@gmail.com](mailto:evankonggg@gmail.com)
